<template>
    <div id="ogs-site-layout">
        ...
        <div id="ogs-sl-main-column" :class="[
            ...
            <div id="ogs-sl-header-authenticated" v-if="is_authenticated" class="sticky top-0 z-40 lg:px-8">
                <slot name="header" />
            </div>
            <div id="ogs-sl-top-nav-public" v-else class="sticky top-0 z-40 sm:px-6 lg:px-36">
                <slot name="topNavigation" />
            </div>

            <main id="ogs-sl-main" class="mb-auto mx-auto w-full py-4 px-4 sm:px-6 lg:px-44 overflow-auto scrollbar">
                <slot name="toast" />
